...
public class ItemManager {
    ...
    /**
     * Klucz custom item modelu (komponent minecraft:item_model).
     * Wskazuje na plik resource packa: assets/dragonsword/items/smoczy_miecz.json
     */
    private final NamespacedKey itemModelKey;

    public ItemManager(JavaPlugin plugin) {
        this.swordKey = new NamespacedKey(plugin, "dragon_sword");
        // Nazwa pluginu "DragonSword" daje namespace "dragonsword".
        this.itemModelKey = new NamespacedKey(plugin, "smoczy_miecz");
    }
    ...
    public ItemStack createDragonSword() {
        ...
        // Custom tekstura - komponent minecraft:item_model (Minecraft 1.21.4+).
        // Wskazuje na model z resource packa: dragonsword:smoczy_miecz
